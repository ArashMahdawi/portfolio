      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Desktop Navigation Links - ALLEEN op desktop */}
            ...
            {/* Desktop CTA Button - ALLEEN op desktop */}
            <motion.a
              href="#contact"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            ...
            {/* Mobile Hamburger Button - geforceerde versie */}
<div className="md:hidden">
  ...
  >
    ...
    >
      ...
      {/* Mobile Menu - rest blijft hetzelfde */}
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <motion.div
              ...
              className="absolute right-0 top-0 h-full w-64 max-w-[80vw] bg-white shadow-xl overflow-y-auto"
